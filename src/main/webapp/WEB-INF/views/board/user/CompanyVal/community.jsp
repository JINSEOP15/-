	...
	<div  style="text-align: center; position: relative; right: 230px;" id="list">
        ...
        <div class="panel-body">  	
        	<table class="table table-striped table-bordered table-hover" style="width: 1000px;">
                	...
                	<c:forEach items="${CompanyVal}" var="board">
                    	<tr class="odd gradeX">
                            ...
                            <td><a class="move" style="text-decoration: none; color: black;" 
                            	   href='/board/user/CompanyVal/reg-detail?bno=<c:out value="${board.bno }"/>'>
           	...
           	<div class='row'>
            	<div class="col-lg-12">
                	<form id='searchForm' action="/board/user/CompanyVal/community" method="get">
                    	<select name='type'>
                        	<option value=""
		...
		<form id="actionForm" action="/board/user/CompanyVal/community" method='get'>
...
<script type="text/javascript">
	...
	function goPost(Views){
		...
		p2.setAttribute('action','/board/user/CompanyVal/community');
	...
	function goPost2(Likes){
		...
		p2.appendChild(obj2);
		p2.setAttribute('method','post');
		p2.setAttribute('action','/board/user/CompanyVal/community2');
		document.body.appendChild(p2);
		p2.submit(); 
...
$(document).ready(function () {
	...
	$("#regBtn").on("click", function () {
		self.location = "/board/user/CompanyVal/reg";
	});
